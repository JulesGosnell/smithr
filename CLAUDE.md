...
│   │   ├── lease.clj           ← Lease acquire/release/GC + SSH tunnels
...
| DELETE | `/api/leases/{id}` | Release a lease |
...
- **SSH tunnels on lease**: Hammar creates tunnel on acquire, destroys on release/GC.
